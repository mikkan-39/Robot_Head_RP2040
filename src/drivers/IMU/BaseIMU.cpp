...
int16_t BaseIMU::readX() {
  return (static_cast<uint16_t>(_readByte(BASE_IMU_OUT_X_H))
          << 8) |
         _readByte(BASE_IMU_OUT_X_L);
}

int16_t BaseIMU::readY() {
  return (static_cast<uint16_t>(_readByte(BASE_IMU_OUT_Y_H))
          << 8) |
         _readByte(BASE_IMU_OUT_Y_L);
}

int16_t BaseIMU::readZ() {
  return (static_cast<uint16_t>(_readByte(BASE_IMU_OUT_Z_H))
          << 8) |
