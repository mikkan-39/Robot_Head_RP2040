...
Accelerometer::Accelerometer(uint8_t slaveAddress) : BaseIMU(slaveAddress) {}

void Accelerometer::begin() {
  _scalingFactor = 1;
  uint8_t command = LIS331DLH_CTRL_REG1_X_EN | LIS331DLH_CTRL_REG1_Y_EN |
                    LIS331DLH_CTRL_REG1_Z_EN | LIS331DLH_CTRL_REG1_PM0;

  uint8_t data[2] = {BASE_IMU_CTRL_REG1, command};
  i2c_write_blocking(i2c0, LIS331DLH_SLAVE_ADDRESS, data, sizeof(data), false);
