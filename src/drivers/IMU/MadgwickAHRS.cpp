#include "drivers/IMU/MadgwickAHRS.h"
#include <math.h>
...
void Madgwick::readQuaternion(float &q0, float &q1,
                              float &q2, float &q3) {
  q0 = _q0;
  q1 = _q1;
  q2 = _q2;
...
void Madgwick::update(float gx, float gy, float gz,
  ...
  float _2q0mx, _2q0my, _2q0mz, _2q1mx, _2bx, _2bz, _4bx,
      _4bz, _2q0, _2q1, _2q2, _2q3, _2q0q2, _2q2q3, q0q0,
  ...
  if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
    ...
    hx = mx * q0q0 - _2q0my * _q3 + _2q0mz * _q2 +
         mx * q1q1 + _2q1 * my * _q2 + _2q1 * mz * _q3 -
         mx * q2q2 - mx * q3q3;
    hy = _2q0mx * _q3 + my * q0q0 - _2q0mz * _q1 +
         _2q1mx * _q2 - my * q1q1 + my * q2q2 +
         _2q2 * mz * _q3 - my * q3q3;
    _2bx = sqrt(hx * hx + hy * hy);
    _2bz = -_2q0mx * _q2 + _2q0my * _q1 + mz * q0q0 +
           _2q1mx * _q3 - mz * q1q1 + _2q2 * my * _q3 -
           mz * q2q2 + mz * q3q3;
    _4bx = 2.0f * _2bx;
    _4bz = 2.0f * _2bz;
  ...
  // Integrate rate of change of quaternion to yield
  // quaternion
  ...
  recipNorm =
      sqrtf(_q0 * _q0 + _q1 * _q1 + _q2 * _q2 + _q3 * _q3);
  recipNorm = 1 / recipNorm;
  _q0 *= recipNorm;
  _q1 *= recipNorm;
  _q2 *= recipNorm;
...
void Madgwick::update(float gx, float gy, float gz,
  ...
  float s0, s1, s2, s3;
  float qDot0, qDot1, qDot2, qDot3;
  float _2q0, _2q1, _2q2, _2q3, _4q0, _4q1, _4q2, _8q1,
      _8q2, q0q0, q1q1, q2q2, q3q3;
  // Rate of change of quaternion from gyroscope
  qDot0 = 0.5f * (-_q1 * gx - _q2 * gy - _q3 * gz);
  qDot1 = 0.5f * (_q0 * gx + _q2 * gz - _q3 * gy);
  qDot2 = 0.5f * (_q0 * gy - _q1 * gz + _q3 * gx);
  ...
  if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
    ...
    s1 = _4q1 * q3q3 - _2q3 * ax + 4.0f * q0q0 * _q1 -
         _2q0 * ay - _4q1 + _8q1 * q1q1 + _8q1 * q2q2 +
         _4q1 * az;
    s2 = 4.0f * q0q0 * _q2 + _2q0 * ax + _4q2 * q3q3 -
         _2q3 * ay - _4q2 + _8q2 * q1q1 + _8q2 * q2q2 +
         _4q2 * az;
    s3 = 4.0f * q1q1 * _q3 - _2q1 * ax + 4.0f * q2q2 * _q3 -
         _2q2 * ay;
...
void Madgwick::readQuaternions(float *q0, float *q1,
                               float *q2, float *q3) {
  *q0 = _q0;
  *q1 = _q1;
  *q2 = _q2;
