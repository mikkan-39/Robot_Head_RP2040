...
void Madgwick::update(float gx, float gy, float gz,
  ...
  if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
    ...
    _2q0mx = 2.0f * _q0 * mx; _2q0my = 2.0f * _q0 * my; _2q0mz = 2.0f * _q0 * mz;
    _2q1mx = 2.0f * _q1 * mx;
    ...
    s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - ax) + _2q1 * (2.0f * q0q1 + _2q2q3 - ay)
         - _2bz * _q2 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
         + (-_2bx * _q3 + _2bz * _q1) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my)
    ...
    s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - ax) + _2q0 * (2.0f * q0q1 + _2q2q3 - ay)
         ...
         + _2bz * _q3 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
    ...
    s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - ax) + _2q3 * (2.0f * q0q1 + _2q2q3 - ay)
         ...
         + (-_4bx * _q2 - _2bz * _q0) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
    ...
    s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - ax) + _2q2 * (2.0f * q0q1 + _2q2q3 - ay)
         + (-_4bx * _q3 + _2bz * _q1) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
    ...
    qDot0 -= _beta * s0; qDot1 -= _beta * s1;
    qDot2 -= _beta * s2; qDot3 -= _beta * s3;
  }

  const float inv_freq = 1.0f / _frequency;
  _q0 += qDot0 * inv_freq; _q1 += qDot1 * inv_freq;
  _q2 += qDot2 * inv_freq; _q3 += qDot3 * inv_freq;
...
float Madgwick::getYawRad()   { return atan2(2 * _q1 * _q2 - 2 * _q0 * _q3, 2 * _q0 * _q0 + 2 * _q1 * _q1 - 1); }
float Madgwick::getPitchRad() { return atan2(2 * _q2 * _q3 - 2 * _q0 * _q1, 2 * _q0 * _q0 + 2 * _q3 * _q3 - 1); }
float Madgwick::getRollRad()  { return -1 * atan2(2.0f * (_q0 * _q2 - _q1 * _q3), 1.0f - 2.0f * (_q2 * _q2 + _q1 * _q1)); }

float Madgwick::getYawDeg()   { return getYawRad()   * AHRS_RAD_TO_DEG; }
float Madgwick::getPitchDeg() { return getPitchRad() * AHRS_RAD_TO_DEG; }
float Madgwick::getRollDeg()  { return getRollRad()  * AHRS_RAD_TO_DEG; }
