...
void Accelerometer::begin() {
  _scalingFactor = 1;
  uint8_t command = LIS331DLH_CTRL_REG1_X_EN |
                    LIS331DLH_CTRL_REG1_Y_EN |
                    LIS331DLH_CTRL_REG1_Z_EN |
                    LIS331DLH_CTRL_REG1_PM0;
  _writeByte(BASE_IMU_CTRL_REG1, command);
...
float Accelerometer::readAccelerationAX() { return readAccelerationGX() * GRAVITY_EARTH; }
float Accelerometer::readAccelerationAY() { return readAccelerationGY() * GRAVITY_EARTH; }
float Accelerometer::readAccelerationAZ() { return readAccelerationGZ() * GRAVITY_EARTH; }
