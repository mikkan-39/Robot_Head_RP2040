...
constexpr float SENS_250DPS  = 0.00875f;
constexpr float SENS_500DPS  = 0.0175f;
constexpr float SENS_2000DPS = 0.07f;

enum class GyroscopeRange { RANGE_250DPS = 1, RANGE_500DPS = 2, RANGE_2000DPS = 3 };
